...
/**
 * Helpers de présentation : transforment une ligne du catalogue en libellés
 * prêts pour l'UI. Acceptent l'item de liste comme le produit complet.
 * (Le web et le mobile ne partagent pas leurs composants ; cette logique
 * d'affichage est volontairement dupliquée.)
 */
