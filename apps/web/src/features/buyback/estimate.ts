...
/**
 * Barème de reprise — copie côté web pour l'aperçu instantané. La valeur
 * faisant foi est recalculée par l'API au moment de la demande (le package de
 * contrats ne peut pas exposer cette fonction comme valeur à l'API NestJS).
 */
